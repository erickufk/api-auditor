 ...
 * Drop this component into your project and use it as a wrapper
 *
 * Usage:
 * <AnimatedBackground>
 *   <YourContent />
...
export function AnimatedBackground({ children, className = "", showGradients = true }: AnimatedBackgroundProps) {
  return (
        ...
        >
          <g clipPath="url(#clip0_bg)">
            <mask
              ...
              height="812"
            >
              <rect x="10" y="-0.84668" width="1200" height="811.693" fill="url(#paint0_linear_bg)" />
            </mask>
            <g mask="url(#mask0_bg)">
              {/* Grid Pattern - 35 columns x 22 rows */}
              {[...Array(35)].map((_, i) => (
          ...
          <defs>
            ...
            >
              ...
              <feGaussianBlur stdDeviation="159.394" result="effect1_foregroundBlur_bg" />
            </filter>
            <filter
              id="filter1_f_bg"
              x="-554.207"
            ...
            >
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
              <feGaussianBlur stdDeviation="478.182" result="effect1_foregroundBlur_bg" />
            </filter>
            <filter
              id="filter2_f_bg"
              x="426.762"
            ...
            >
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
              <feGaussianBlur stdDeviation="79.6969" result="effect1_foregroundBlur_bg" />
            </filter>
            <filter
              id="filter3_f_bg"
              x="-253.163"
